---
name: cso
description: Security audit — OWASP top-10 scan, STRIDE threat model, secrets grep, supply-chain check. Output is a severity-ranked findings report.
argument-hint: "<optional: path to scope, default: repo root>"
---
