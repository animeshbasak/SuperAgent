...
name: video-craft
description: >
  Author HTML video compositions and render them to MP4 with hyperframes. Use this
  skill whenever the user asks to "make a video", produce an MP4, generate motion
  graphics, animate a chart, render an explainer, build a product ad, ship a TikTok
  / Reels / Shorts hook, add a lower-third overlay, render a logo sting, or turn
  text/data/images into a finished video file. Trigger on keywords: video, MP4,
  render, composition, hyperframes, GSAP, motion graphics, animated chart, data
  viz video, lower-third, product ad, explainer, social cut, kinetic typography,
  scene, timeline, frame-accurate, deterministic render, FFmpeg pipeline. Also
  trigger on indirect cues like "turn this into a video", "animate this title",
  "30-second hero video", "9:16 vertical video", or any request that ends in an
  MP4 file. Do NOT trigger for live web animation, scroll-driven hero, or
  realtime UI motion — that is webgl-craft territory. video-craft is the path
  when the deliverable is a rendered video file.
argument-hint: "[recipe-name | composition.html]"
---
